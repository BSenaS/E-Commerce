  ...
  return (
    <div className="">
      ...
      <div className="max-w-full bg-[#252B42]">
        <div className="flex flex-row flex-wrap max-w-[1440px] mx-auto justify-between items-center  min-h-[58px] px-[1.5em]">
      ...
      {/*Navbar Light */}
      <div className="flex justify-between items-center px-[1.5em] max-w-[1440px] mx-auto ">
