...
export const ProductInfo = () => {
  return (
    <div className="w-full my-8">
      ...
      <div className="flex flex-row max-w-[1050px] tracking-[0.2px] mx-auto justify-between flex-wrap">
        {/* Resim */}
        <div>
          <img src={productInfo} alt="" className="h-[400px] max-w-[340px]" />
        </div>
        {/* Product Açıklaması */}
        <div className="flex flex-col max-w-[332px] gap-4">
